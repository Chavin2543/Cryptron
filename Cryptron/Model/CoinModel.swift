...
struct CoinModel : Identifiable, Codable {
    ...
    func updateHoldings(amount:Double,entry:Double) -> CoinModel {
    ...
    var initialHoldingsValue:Double {
        return (entryPrice ?? 0) * (currentHoldings ?? 0)
    }
    
    var profit:Double {
        return currentHoldingsValue - initialHoldingsValue
    }
    
    var profitPercentage:Double {
        return profit/currentHoldingsValue*100
    }
